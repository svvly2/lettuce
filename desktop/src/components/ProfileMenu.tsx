...
export function ProfileMenu({ user, onLogout }: { user: RobloxUser; onLogout(): void }) {
  ...
  return <div className="profile" ref={root}>
    ...
    {open && <div className="menu account-menu"><button className="danger" onClick={onLogout}><Icon name="logout" />log out</button></div>}
  </div>;
}
