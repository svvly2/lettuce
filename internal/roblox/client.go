...
func NewOAuthAuthenticatedClient(accessToken string, userInfo UserInfo) *Client {
	return &Client{
...
func (c *Client) IsOAuthOnly() bool {
	return strings.TrimSpace(c.AccessToken) != "" && strings.TrimSpace(c.Cookie) == ""
}
